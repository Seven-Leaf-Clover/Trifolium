SMODS.Joker:take_ownership('opan_chameleon_hook', { 
	...
	if context.end_of_round and context.cardarea == G.jokers and not context.blueprint then
	    ...
	    if #_poker_hands > 0 then
	        ...
	        return { message = localize('k_reset'), colour = G.C.GREEN }
	    end
        end

	if context.before and context.scoring_name == card.ability.hook_poker_hand then
	    return {
